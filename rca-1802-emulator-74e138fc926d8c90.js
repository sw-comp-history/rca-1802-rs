...
export class WasmCpu {
     ...
     */
    get_cycles() {
        const ret = wasm.wasmcpu_get_cycles(this.__wbg_ptr);
     ...
     */
    get_d() {
        const ret = wasm.wasmcpu_get_d(this.__wbg_ptr);
        return ret;
    }
    /**
     * Get DF (data flag)
     ...
     */
    get_df() {
        const ret = wasm.wasmcpu_get_df(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get_ie() {
        const ret = wasm.wasmcpu_get_ie(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get_instructions() {
        const ret = wasm.wasmcpu_get_instructions(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
     * Get memory contents
     ...
     */
    get_p() {
        const ret = wasm.wasmcpu_get_p(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    get_q() {
        const ret = wasm.wasmcpu_get_q(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get_register(reg) {
        const ret = wasm.wasmcpu_get_register(this.__wbg_ptr, reg);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0];
     ...
     */
    get_x() {
        const ret = wasm.wasmcpu_get_x(this.__wbg_ptr);
        return ret;
    }
    /**
     * Check if halted
     ...
     */
    set_d(value) {
        wasm.wasmcpu_set_d(this.__wbg_ptr, value);
    }
    /**
     * Set DF
     * @param {boolean} value
     */
    set_df(value) {
        wasm.wasmcpu_set_df(this.__wbg_ptr, value);
    }
    /**
     * Set P selector
     * @param {number} value
     */
    set_p(value) {
        const ret = wasm.wasmcpu_set_p(this.__wbg_ptr, value);
        if (ret[1]) {
    ...
    set_register(reg, value) {
        const ret = wasm.wasmcpu_set_register(this.__wbg_ptr, reg, value);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    set_x(value) {
        const ret = wasm.wasmcpu_set_x(this.__wbg_ptr, value);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 398, function: Function { arguments: [Ref(NamedExternref("Event"))], shim_idx: 377, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
        ...
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 470, function: Function { arguments: [Externref], shim_idx: 489, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
    ...
    return {
        __proto__: null,
        "./rca-1802-emulator_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rca-1802-emulator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
